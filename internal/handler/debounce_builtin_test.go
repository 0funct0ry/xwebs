...
func TestDebounceBuiltin(t *testing.T) {
	...
	t.Run("Basic debounce with respond", func(t *testing.T) {
		...
		d := NewDispatcher(reg, conn, engine, true, nil, nil, false, nil, nil, nil, nil, nil, nil, nil, "")
	...
	t.Run("Scoped debouncing - client vs global", func(t *testing.T) {
		...
		d1 := NewDispatcher(reg, conn1, engine, true, nil, nil, false, nil, nil, nil, nil, nil, nil, nil, "")
		d2 := NewDispatcher(reg, conn2, engine, true, nil, nil, false, nil, nil, nil, nil, nil, nil, nil, "")
