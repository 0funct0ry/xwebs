...
func TestOllamaGenerateBuiltin(t *testing.T) {
	...
	d := NewDispatcher(reg, mockConn, engine, true, nil, nil, false, nil, nil, nil, nil, nil, nil, nil, nil, nil, server.URL+"/api/generate")
...
func TestOllamaChatBuiltin(t *testing.T) {
	...
	d := NewDispatcher(reg, mockConn, engine, true, nil, nil, false, nil, nil, nil, nil, nil, nil, nil, nil, nil, server.URL+"/api/chat")
...
func TestOllamaEmbedBuiltin(t *testing.T) {
	...
	d := NewDispatcher(reg, mockConn, engine, true, nil, nil, false, nil, nil, nil, nil, nil, nil, nil, nil, nil, server.URL+"/api/embeddings")
