...
func TestRateLimitBuiltin(t *testing.T) {
	...
	t.Run("Client Scope (Default)", func(t *testing.T) {
		...
		d1 := NewDispatcher(registry, conn1, engine, true, nil, nil, false, nil, nil, nil, nil, nil, nil, nil, nil, "")
		d2 := NewDispatcher(registry, conn2, engine, true, nil, nil, false, nil, nil, nil, nil, nil, nil, nil, nil, "")
	...
	t.Run("Dynamic Rate Template", func(t *testing.T) {
		...
		d := NewDispatcher(registry, conn1, engine, true, nil, nil, false, nil, nil, nil, kv, nil, nil, nil, nil, "")
		action := &Action{
