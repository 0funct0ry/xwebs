...
func (m *rateLimitMockConn) GetID() string                     { return "mock-ratelimit-conn" }
...
func TestDispatcherRateLimit(t *testing.T) {
	...
	dispatcher := NewDispatcher(registry, conn, engine, true, nil, nil, false, nil, nil, nil, nil, nil, nil, nil, nil, nil, "")
