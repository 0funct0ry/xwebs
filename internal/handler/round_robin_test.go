...
func TestRoundRobinBuiltin(t *testing.T) {
	...
	d := NewDispatcher(reg, conn, engine, true, nil, nil, false, nil, stats, nil, nil, nil, nil, nil, nil, "")
...
func TestRoundRobinTemplatePool(t *testing.T) {
	...
	d := NewDispatcher(reg, conn, engine, true, vars, nil, false, nil, stats, nil, nil, nil, nil, nil, nil, "")
