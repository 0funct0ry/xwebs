...
func TestSequenceBuiltin(t *testing.T) {
	...
	dispatcher := NewDispatcher(registry, conn, engine, false, nil, nil, false, nil, nil, nil, nil, nil, nil, nil, nil, nil, "")
...
func TestSequenceBuiltinPerClient(t *testing.T) {
	...
	d1 := NewDispatcher(registry, conn1, engine, false, nil, nil, false, nil, nil, nil, nil, nil, nil, nil, nil, nil, "")
	d2 := NewDispatcher(registry, conn2, engine, false, nil, nil, false, nil, nil, nil, nil, nil, nil, nil, nil, nil, "")
