...
func TestHandlerVariables(t *testing.T) {
	...
	d := NewDispatcher(reg, conn, engine, true, globalVars, sessionVars, false, nil, nil, nil, nil, nil, nil, nil, nil, "")
...
func TestHandlerVariableOverride(t *testing.T) {
	...
	d := NewDispatcher(reg, conn, engine, true, globalVars, nil, false, nil, nil, nil, nil, nil, nil, nil, nil, "")
